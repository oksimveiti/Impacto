...
export async function editEventToFirestore(eventData) {
  try {
    ...
    const docRef = await setDoc(doc(db, "events", EditeventId), eventToSave);
    ...
    console.error("Error in editEventToFirestore:", error);
    throw error;
  }
}
