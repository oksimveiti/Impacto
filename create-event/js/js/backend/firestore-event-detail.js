...
export async function getEventDetails(eventId) {
  ...
  try {
    ...
    // 日時データのデバッグ
    console.log("Event start date:", eventData.event_start_date_time);
    console.log("Event end date:", eventData.event_end_date_time);
    ...
    // 日時の表示
    if (eventData.event_start_date_time && eventData.event_end_date_time) {
      ...
      document.getElementById(
        "startDateTime"
      ).textContent = `${startDate.toLocaleString("en-US", dateOptions)}`;

      document.getElementById(
        "endDateTime"
      ).textContent = `${endDate.toLocaleString("en-US", dateOptions)}`;
      ...
      console.log("Event dates are missing or invalid:", {
        start: eventData.event_start_date_time,
        end: eventData.event_end_date_time,
      });
    }

    // 場所の表示
    if (eventData.neighborhood && eventData.city && eventData.province) {
